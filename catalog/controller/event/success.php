<?php
class ControllerEventSuccess extends Controller {

    public function index() {
        $this->load->language('event/success');

        $this->document->setTitle($this->language->get('Thank you'));
        ...
        $this->response->setOutput($this->load->view('event/success', $data));
    }
}