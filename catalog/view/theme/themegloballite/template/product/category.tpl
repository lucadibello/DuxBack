...
<?php include('catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/template/themeglobal/themeglobal_top.tpl'); ?>
  ...
  <!-- Products list -->
  <?php include('catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/template/themeglobal/product_list.tpl'); ?>
  	...
  	<div class="row">
	  	<?php $row_fluid = 0; foreach ($products as $product) { $row_fluid++; ?>
		  	...
		  	<div class="col-sm-<?php echo $class; ?>">
		  	    <?php include('catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/template/themeglobal/product_grid.tpl'); ?>
		  	</div>
	    <?php } ?>
    </div>
  </div>
