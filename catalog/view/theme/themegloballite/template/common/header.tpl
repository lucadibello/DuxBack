...
<head>
	...
	<?php $listcssjs = array(
			...
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/bootstrap-theme.css',
			...
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/slider.css',
			...
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/magnific-popup.css',
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/jquery-ui.css',
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/notification.css',
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/owl.carousel.css',
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/carousel.css'
	); 
		
	if($theme_options->get( 'page_width' ) == 1) {
		$listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/wide-grid.css';
	} 
	
	if($theme_options->get( 'page_width' ) == 3) {
		$listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/standard-grid.css';
	} 
?>
		
	<?php echo $theme_options->compressorCodeCss( $config->get('theme_' . $config->get('config_theme') . '_directory'), $listcssjs, 0, HTTP_SERVER ); ?>
	...
	<!--[if IE 8]>
		<link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php echo $config->get('theme_' . $config->get('config_theme') . '_directory'); ?>/css/ie8.css" />
	<![endif]-->
    ...
    <?php $listcssjs = array(
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.min.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery-migrate-1.2.1.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery-ui-1.10.4.custom.min.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/bootstrap.min.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/twitter-bootstrap-hover-dropdown.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.themepunch.plugins.min.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.themepunch.revolution.min.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/common.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.cookie.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.magnific-popup.min.js',
    		'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.elevateZoom-3.0.3.min.js',
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/modernizr.js',
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/notify.js',
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/owl.carousel.min.js',
			'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.jcarousel.min.js'
    ); ?>
    	
     <?php echo $theme_options->compressorCodeJs( $config->get('theme_' . $config->get('config_theme') . '_directory'), $listcssjs, 0, HTTP_SERVER ); ?>
	...
	<script type="text/javascript" src="catalog/view/theme/<?php echo $config->get('theme_' . $config->get('config_theme') . '_directory'); ?>/js/jquery.nivo.slider.pack.js"></script>
	<?php } else { ?>
