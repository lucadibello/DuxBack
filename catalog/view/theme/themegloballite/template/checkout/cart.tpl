      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
              ...
              &nbsp;
              <input type="image" src="catalog/view/theme/<?php echo $config->get('theme_' . $config->get('config_theme') . '_directory'); ?>/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
              &nbsp;<a onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><img src="catalog/view/theme/<?php echo $config->get('theme_' . $config->get('config_theme') . '_directory'); ?>/image/remove.png" alt="<?php echo $button_remove; ?>"  style="cursor:pointer;" title="<?php echo $button_remove; ?>" /></a>
          </td>
        ...
        <tr>
          ...
          <td class="text-center">
              ...
              &nbsp;<a onclick="voucher.remove('<?php echo $vouchers['key']; ?>');"><img src="catalog/view/theme/<?php echo $config->get('theme_' . $config->get('config_theme') . '_directory'); ?>/img/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a>
          </td>
